...
// DOM references
// ---------------------------------------------------------------------------
const modeScreen = document.getElementById('pong-mode-screen') as HTMLElement
const gameScreen = document.getElementById('pong-game-screen') as HTMLElement
...
function startGame(selectedMode: '1p' | '2p'): void {
  mode = selectedMode
...
// ---------------------------------------------------------------------------
const touchSide: Map<number, 'left' | 'right'> = new Map()
