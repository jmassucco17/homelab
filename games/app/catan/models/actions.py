...
class PlaceSettlement(BaseAction):
    ...
    action_type: ActionType = ActionType.PLACE_SETTLEMENT
    vertex_id: int
...
class PlaceRoad(BaseAction):
    ...
    action_type: ActionType = ActionType.PLACE_ROAD
    edge_id: int
...
class PlaceCity(BaseAction):
    ...
    action_type: ActionType = ActionType.PLACE_CITY
    vertex_id: int
...
class PlayMonopoly(BaseAction):
    ...
    action_type: ActionType = ActionType.PLAY_MONOPOLY
...
class TradeOffer(BaseAction):
    ...
    action_type: ActionType = ActionType.TRADE_OFFER
...
class TradeWithBank(BaseAction):
    ...
    action_type: ActionType = ActionType.TRADE_WITH_BANK
    giving: ResourceType
...
class TradeWithPort(BaseAction):
    ...
    action_type: ActionType = ActionType.TRADE_WITH_PORT
    giving: ResourceType
...
class MoveRobber(BaseAction):
    ...
    action_type: ActionType = ActionType.MOVE_ROBBER
...
class StealResource(BaseAction):
    ...
    action_type: ActionType = ActionType.STEAL_RESOURCE
...
class DiscardResources(BaseAction):
    ...
    action_type: ActionType = ActionType.DISCARD_RESOURCES
...
class CancelTrade(BaseAction):
    ...
    action_type: ActionType = ActionType.CANCEL_TRADE
    trade_id: str
